#!/usr/bin/env python3
"""
Schritt 1 - Transaktionen 2024 aus dem Finom-Kontoauszug (Ersatz fuer die nicht
...
Identischer Prozess wie Belegauswertung_2025/scripts/step1_transaktionen.py, nur auf
Jahr 2024 gefiltert und mit eigenem, getrenntem out/-Ordner (Belegauswertung_2024).
"""
import json
import re

ALL_TX = "/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/Belegauswertung_2025/out/_finom_alle_jahre.json"
OUT = "/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/Belegauswertung_2024/out/01_transaktionen.json"
...
def main():
    ...
    tx2024 = [t for t in all_tx if not t.get('parse_error') and t['zahlungsdatum'].startswith('2024')]
