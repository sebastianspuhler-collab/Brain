#!/usr/bin/env python3
"""Schritt 4: Belege <-> Transaktionen matchen. Identisch zu Belegauswertung_2025/scripts/
step4_matching.py, aber auf Jahr 2024 umgestellt (eigener, getrennter out/-Ordner)."""
import json, re
from datetime import date, timedelta

TX_PATH = "/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/Belegauswertung_2024/out/01_transaktionen.json"
BELEGE_PATH = "/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/Belegauswertung_2024/out/02_belege_ordner.json"
OUT = "/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/Belegauswertung_2024/out/04_merged.json"
JAHR = "2024"
...
def main():
    ...
    for b in belege:
        ...
        if rd and not rd.startswith(JAHR):
            # Auch PRUEFFALL-Belege (z.B. Fremdwaehrung) mit eindeutig anderem Jahr
            # gehoeren nicht in diese Auswertung - sonst tauchen 2025er-Belege in der
            # 2024er-Pruefaelle-Liste auf, nur weil sie in Schritt 2 pauschal als
            # PRUEFFALL markiert wurden (z.B. Fremdwaehrung), unabhaengig vom Jahr.
    ...
    with open("/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/Belegauswertung_2024/out/ausserhalb_zeitraum.json", 'w', encoding='utf-8') as f:
