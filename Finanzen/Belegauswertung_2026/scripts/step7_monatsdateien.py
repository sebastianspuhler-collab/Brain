...
OUTFILE = f"{BASE}/ergebnis_2026_monatlich_netto.xlsx"
...
# Netto-Umsatz/-Ausgabe/-Verlust, bleiben aber sichtbar (grau, mit Grund).
BAGATELLE_AUSSCHLUSS_GRENZE = 10.0
DURCHLAUFPOSTEN_TX_IDS = set()  # 2025 war "FINOM-ab4c797b9d8a034a" etc. (Benito Ferrise Rundlauf) - fuer 2026 leer, bei Bedarf 2026-spezifische Durchlaufposten-tx_ids eintragen.
...
# ---------- Letztes Blatt: Jahresgesamtrechnung ----------
...
# Synchronisierte Kopie in den Jahresordner (Nutzerwunsch 2026-07-22).
JAHRESORDNER = "/Users/sesp01-user/vault/Prozessia-Brain/Finanzen/2026"
shutil.copy2(OUTFILE, f"{JAHRESORDNER}/ergebnis_2026_monatlich_netto.xlsx")

print()
print("Datei:", OUTFILE)
print("Kopie synchronisiert nach:", f"{JAHRESORDNER}/ergebnis_2026_monatlich_netto.xlsx")
