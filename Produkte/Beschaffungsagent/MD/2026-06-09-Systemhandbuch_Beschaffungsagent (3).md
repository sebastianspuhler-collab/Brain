...
tags:
  ...
  - Dashboard
  - Dokumentation
quelle: Systemhandbuch_Beschaffungsagent (3).pdf
datum: 2026-06-09
kategorie: Produkt
---

# Systemhandbuch_Beschaffungsagent (3)

Systemhandbuch für den Beschaffungsagenten, entwickelt für die Schaufler Fischer Group. Das Dokument beschreibt die Funktionsweise des Systems zur Überwachung von Auftragsbestätigungen, Lieferterminen und Versanddokumenten mit KI-Unterstützung. Es enthält eine detaillierte Seitenübersicht des Dashboards mit Rollenzuweisungen und Navigationsstruktur.
...
Wichtige Hinweise:
•  Auch die Aufrufe `/bestellungen` und `/eskalationen` führen a
