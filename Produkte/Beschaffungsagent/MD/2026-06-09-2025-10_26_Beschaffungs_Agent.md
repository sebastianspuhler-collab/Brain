...
Das Dokument präsentiert das Konzept eines KI-basierten Beschaffungsagenten, der E-Mail-Postfächer überwacht, Auftragsbestätigungen in Datenbanken (Proleis/Winform) und ELO ablegt sowie Liefertermine verfolgt. Der Agent automatisiert mehrstufige Erinnerungsprozesse bei fehlenden Auftragsbestätigungen und verspäteten Lieferterminen. Beteiligte Systeme sind Outlook, ELO und Proleis/Winform, Stakeholder sind Lieferanten und Einkäufer.
